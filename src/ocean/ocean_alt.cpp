...
//void ocean_alt::updateVertexAmplitudes(double t){
//    for (int i = 0; i < N; i++){
...
///*
// * h'(x,t) in terms of n' and m', where x = (x,z)
// * note that 0 <= n' = m' <= length-1;
// */
//void ocean_alt::fft_at_t(){
...
///*
// * h_'(x,t) in terms of n' and m'
// * See equation (43) in paper.
// */
//void ocean_alt::fourier_amp_at_t(int n_prime, int m_prime){
...
///*
// * h_0'(x,t) in terms of n' and m'
// * See equation (42) in paper.
// */
//void ocean_alt::fourier_amp_0(int n_prime, int m_prime){

//}

//void ocean_alt::phillips_prime(int n_prime, int m_prime){
...
///*
// * w'(n', m') in terms of n' and m'
// * See section 4.2) in paper. N= length and M=width.
// */
//double ocean_alt::w_prime(double n_prime, double m_prime){
//    // calculate w^4 first to avoid multiple sqrt
//    double N_ = (double)length;
//    double M_ = (double)width;


//    double inner_n = (2.0*M_PI*n_prime - M_PI*N_) / L;
//    double inner_m = (2.0*M_PI*m_prime - M_PI*M_) / L;
//    double w_4 = gravity*gravity * (inner_n*inner_n + inner_m*inner_m);
//    return pow(w_4, .25);

//}


//// gets k vector from a given m and n index
//Eigen::Vector2d ocean_alt::get_k_vector(int n_prime, int m_prime){
//    double k_x = 2*M_PI*n_prime - M_PI*length / L;
//    double k_
//    Eigen::Vector2d k = Eigen::Vector2d()
//}

//////////////

//std::pair<double, double> ocean_alt::index_to_n_m(int index){
...
//std::pair<double, double> ocean_alt::k_index_to_k_vector(int k_index)
//{
...
// */
//double ocean_alt::phillips_spectrum
//    (
//    int k_index
//    )
//{
...
// */
//std::pair<double, double> ocean_alt::amplitude_0
//    (
//        int k_index
//    )
//{
...
// */
//int ocean_alt::k_index_to_negative_k_index
//    (
//        int k_index
//    )
//{
...
// */
//double ocean_alt::omega_dispersion
//    (
//        double k_magnitude,
//        bool is_shallow
//    )
...
//std::pair<double, double> ocean_alt::exp_complex
//    (
...
// * See section 4.4 of the paper.
// */
//std::pair<double, double> ocean_alt::amplitude_t
//    (
//        double t,
//        int k_index
//    )
